    ...
    export function ItemDetails({ item, onEdit, onDelete, onAdjust }: ItemDetailsProps) {
      const handleDelete = () => {
        if (confirm(`Are you sure you want to delete "${item.name}"?`)) {
          onDelete(item.id);
          // Toast moved to page level for navigation consistency
        }
      };
            ...
            <CardHeader>
              <CardTitle className="flex justify-between items-start">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button variant="outline" size="icon" className="text-destructive hover:bg-destructive/10 hover:text-destructive" onClick={handleDelete} title="Delete Item">
